<template>
    <div class="container">
        ...
        <div v-if="sessionMessage" class="mt-3 alert alert-danger" :class="'alert-'+sessionMessage.status">
            <p class="mb-0">{{ sessionMessage.content }}</p>
        </div>
        <div v-if="villages" class="row mt-3">
            <div class="col overflow-auto mb-3">
                <table v-if="villagesToShow && villagesToShow.length" class="table table-bordered table-hover mb-0">
...
export default {
    ...
    computed: {
        ...mapState('Main', ['user', 'backendRoutes']),
